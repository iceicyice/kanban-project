...
<x-filament-panels::page>
    ...
    <div id="kanban-board">
        <div id="kanban-statuses" class="md:flex gap-7 pb-4 overflow-x-auto">
    ...
    <div
        ...
        class="fixed inset-0 flex items-center justify-center bg-white/70 dark:bg-gray-800/70 z-50"
    >
